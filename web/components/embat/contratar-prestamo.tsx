        ...
        <div className="flex min-w-0 flex-1 flex-col items-start gap-2.5 overflow-hidden p-2.5">
          ...
          {isPending ? (
            <button
              type="button"
              onClick={cancel}
              className="flex h-8 w-full shrink-0 items-center justify-center overflow-hidden rounded-xl border border-[#dce0e6] bg-white px-2.5 text-[15px] leading-none font-semibold tracking-[-0.15px] text-[#666]"
            >
              Cancelar
            </button>
          ) : null}
