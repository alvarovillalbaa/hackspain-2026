  ...
  return (
    <ScrollAreaPrimitive.Scrollbar
      ...
      className={cn(
        ...
        size === "modal"
          ? "data-horizontal:h-1.5 data-horizontal:flex-col data-vertical:h-full data-vertical:w-1.5"
    ...
    >
      <ScrollAreaPrimitive.Thumb
        ...
        className={cn(
          ...
          size === "modal" ? "bg-foreground/15" : "bg-border"
        )}
      />
    </ScrollAreaPrimitive.Scrollbar>
  )
