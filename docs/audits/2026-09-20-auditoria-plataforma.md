...
| `GET` | `/api/xray/actions` | Acciones de cartera: dos listados del store (packs importados + acciones Eve) en vez de dos lecturas por empresa; memo por versión del store, TTL 60 s (20 sep) |
