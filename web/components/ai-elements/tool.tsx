...
// Used by other AI Elements (e.g. sandbox.tsx).
...
export const ToolHeader = ({
  ...
  return (
    <CollapsibleTrigger
      className={cn(
        "group/tool-trigger flex w-full items-center gap-2 py-0.5 text-left text-muted-foreground transition-colors hover:text-foreground",
        className,
      )}
      {...props}
    >
      ...
      {/* Base UI marks an expanded trigger with data-panel-open. */}
      <ChevronRightIcon className="size-3.5 shrink-0 transition-transform group-data-panel-open/tool-trigger:rotate-90" />
    </CollapsibleTrigger>
  );
};
